                ...
                children: [
                  ...
                  if (!kIsWeb && (Platform.isWindows ||
                    ...
                    _ToggleSetting(
                      ...
                      subtitle:
                          'Al cerrar la ventana, la app seguirá activa en 2do plano',
                  ...
                  if (!kIsWeb && Platform.isAndroid) ...[
                    ...
                    _ToggleSetting(
                      ...
                      onChanged: (v) async {
                        debugPrint(
                          '[StrictMode][Settings] Toggle changed to: $v',
                        );
                        if (v) {
                          // Request permissions when enabling
                          debugPrint(
                            '[StrictMode][Settings] Requesting permissions...',
                          );
                          final service = StrictModeService();
                          await service.init();
                          final granted =
                          ...
                          debugPrint(
                            '[StrictMode][Settings] Permissions granted: $granted',
                          );
                          if (!granted) {
                            // User was sent to system settings — don't enable yet
                            debugPrint(
                              '[StrictMode][Settings] Permissions NOT granted, showing snackbar',
                            );
                            ...
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Acepta los permisos necesarios y vuelve a Hyro.',
                                  ),
                                ),
                              );
                            }
                          ...
                          debugPrint(
                            '[StrictMode][Settings] ✅ Enabling strict mode',
                          );
                        } else {
                          debugPrint(
                            '[StrictMode][Settings] Disabling strict mode',
                          );
                        }
                ...
                builder: (context) {
                  ...
                  return GlassCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Prueba de Notificaciones (Debug)',
                            ...
                            onPressed: () {
                              ...
                              final taskWithDue =
                                  pending
                                      ...
                                      .toList();
                              final taskName =
                                  taskWithDue.isNotEmpty
                                      ? taskWithDue.first.title
                                      : (pending.isNotEmpty
                                          ? pending.first.title
                                          : 'Mi Tarea');
                              NotificationsService.instance.testTaskReminderDay(
                                taskName,
                                1,
                              );
                            },
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: const Text(
                              '🕒 Mostrar Hora del Dispositivo',
                            ),
                            onPressed: () {
                              final now = DateTime.now();
                              final hourStr = now.hour.toString().padLeft(
                                2,
                                '0',
                              );
                              final minStr = now.minute.toString().padLeft(
                                2,
                                '0',
                              );
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    '🕒 La hora local es: $hourStr:$minStr',
                                  ),
                                ),
                              );
                            },
        ...
        SliderTheme(
          ...
          child: Slider(
            ...
            divisions:
                divisions ??
                ((max - min) * 2)
                    .toInt(), // Default to 0.5 steps if no divisions given
            onChanged: onChanged,
          ),
        ),
      ],
